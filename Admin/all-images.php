  ...
  <body>
    <div class="container-scroller">
      ...
      <?php  
        ...
        // $con = mysqli_connect("localhost", "root", "", "golbal courier");
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <?php
                      $dis = mysqli_query($con, "SELECT * FROM `addimage`");
                      if($dis){
                        ...
                        ?>
                          ...
                          <!--Update Button-->
                           <form action="update-images.php" method="post">
                            ...
                            <!--Delete Button-->
                            <form method="post" action="del_images.php">
