...
<html lang="en">
  <head>
    ...
    <?php
      ...
      // $con = mysqli_connect("localhost", "root", "", "golbal courier");   //insert connection
      
    ?>

    <?php  include_once('css.php');     ?>
    <?php  //include_once('service1.php'); ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">INTERNATIONAL SERVICE DATA</h4>
                    <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                    <?php 
                        $dis = mysqli_query($con, "SELECT * FROM `international service`");
                    ...
                    echo '<table class="table table-hover">
                      ...
                      while ($row = mysqli_fetch_array($dis)) {
                         ...
                         echo "<td style='max-width: 200px; overflow: hidden; text-overflow: ellipsis;'>"; echo $row['Description']; echo "</td>";
                         ...
                         echo "<td>";
                            ...
                            <!--Update Button-->
                           <form action="update-service1.php" method="post">
                            ...
                            <!--Delete Button-->
                          <form action="del_service1.php" method="post">
