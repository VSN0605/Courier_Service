...
<html lang="en">
  <head>
    ...
    <title>All Domestic Service Data</title>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">DOMESTIC SERVICE DATA</h4>
                    <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                      <?php
                        $dis = mysqli_query($con, "SELECT * FROM `domestic`");
                        ...
                        echo  '<table class="table table-hover">
                          ...
                          while($row = mysqli_fetch_array($dis)) {
                            ...
                            <!--Delete Button-->
                            <form method="post" action="del_service2.php">
