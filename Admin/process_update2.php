...
<head>
  ...
  <title>Update Domestic Service</title>
        ...
        <div class="content-wrapper">
          ...
          <?php
            if(isset($_POST['update_btn']))
             {
              $query="SELECT * FROM `domestic` WHERE `ID` = '$_POST[update_id]'";
                ...
                <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                  <div class="form-group">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="newID" name="newID" value="<?php echo $row['ID']; ?>" readonly>
                    </div>
          ...
          <?php
            ...
            //   $query="UPDATE `domestic` SET `Image`='$file_name', `Description`='$_POST[Description]', `Text`='$_POST[Text]', `URL`='$_POST[URL]' WHERE `ID`='$_POST[newID]'";
            //   $query_run=mysqli_query($con,$query);
            ...
            //     echo "<script>
            //             setTimeout(function() {
            //                 window.location='all-service2.php';
            //             }, 3000);
            //           </script>";
            //     exit();
            //   } else {
            ...
            if(isset($_POST["submit1"])) {
              ...
              $query = "UPDATE `domestic` SET `Image`=?, `Description`=?, `Text`=?, `URL`=? WHERE `ID`=?";
              $stmt = mysqli_prepare($con, $query);
          
              if ($stmt) {
                  // Bind parameters
                  mysqli_stmt_bind_param($stmt, "ssssi", $file_name, $_POST['Description'], $_POST['Text'], $_POST['URL'], $_POST['newID']);
